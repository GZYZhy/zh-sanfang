...
```bash
# 查询麦克风状态
mosquitto_pub -h 24.233.0.55 -t "zhsf/tally" -m "zhsf_1:m"

# 强制关麦
mosquitto_pub -h 24.233.0.55 -t "zhsf/tally" -m "zhsf_1:g"

# 强制开麦
mosquitto_pub -h 24.233.0.55 -t "zhsf/tally" -m "zhsf_1:k"
```
...
- v1.3 - 添加开麦键模式和MQTT麦克风远程控制
  - 🎚️ 新增开麦键功能：短按切换开麦/关麦状态
  - 📡 新增MQTT麦克风控制：支持远程查询和控制麦克风状态
  - 🛡️ 增强系统稳定性：I2S操作添加超时保护，避免死机
  - 💡 优化LED指示：开麦状态更直观
